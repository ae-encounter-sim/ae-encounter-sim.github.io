...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/5daa792352e10519d01887fe692479a2?language=en'
    banner_name = 'Extra Style Justitia'
    rate_up = ['Isuka','Isuka(ES)']
