...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/b26ecd3f5678cbe9e58b454c88061339?language=en'
    banner_name = 'Another Style Divine Paladin'
    rate_up = ['Anabel','Anabel(AS)']
