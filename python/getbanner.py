...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/8f2d878562620e5cbe463bd840a6d9aa?language=en'
    banner_name = 'Ally Encounter Western Mythos Series'
    rate_up = ['Yipha','Mistrare']
