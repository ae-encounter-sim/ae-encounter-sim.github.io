...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/9dd45abaf64d5e8370434f857cbcd6f7?language=en'
    banner_name = 'Another Style Flare Knight'
    rate_up = ['Radias','Radias(AS)']
