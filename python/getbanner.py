...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/ea76337218b2d63bcc6e34ed38a75541?language=en'
    banner_name = 'Wanderer in the Vortex'
    rate_up = ['Orleya','Miyu','Miyu(ES)']
