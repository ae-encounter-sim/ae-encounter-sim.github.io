...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/3234e9ab35b33f3f80d51c2e0b13df4d?language=en'
    banner_name = 'Manifestation Weapon Discovery Veina Philo'
    rate_up = ['Veina','Philo']
