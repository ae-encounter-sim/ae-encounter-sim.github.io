...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/006f89362558b9bf8cac1e9a68d1642c?language=en'
    banner_name = 'Re-Encounter Ally Encounter Melissa'
    rate_up = ['Melissa','Suzette']
