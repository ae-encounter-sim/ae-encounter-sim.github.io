...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/6074d79178a70ebf7763f80a6e3d3ac0?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Hismena'
    rate_up = ['Shanie(AS)','Dewey','Hismena']
