...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/5785374577e72fc2812e99752821b862?language=en'
    banner_name = 'Another Style Titania'
    rate_up = ['Veina','Veina(AS)']
