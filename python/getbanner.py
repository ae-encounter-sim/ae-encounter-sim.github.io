...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/78470b43239a4b52f2aefe1a2b4c1d7e?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Necoco'
    rate_up = ['Necoco','Garambarrel','Yukino']
