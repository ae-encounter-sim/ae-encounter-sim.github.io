...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/1bb9a4638ce3ba2c99c881c1411984dc?language=en'
    banner_name = 'Another Style Beauty Police'
    rate_up = ['Shannon','Shannon(AS)']
