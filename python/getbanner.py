...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/8362502884c35b248dd987d5a062f4cc?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Ewella'
    rate_up = ['Ewella','Ciel(AS)','Lovely']
