...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/7fcb7dd063179393bd756a309727f0b1?language=en'
    banner_name = 'Fateful Encounter Curse Seeker'
    rate_up = ['Ewan','Ewan(AS)']
