...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/e1a64a05054a9fa7ff72940912e360a3?language=en'
    banner_name = 'Song of Sword and Wings of Lost Paradise'
    rate_up = ['Thillelille','Foran','Foran(AS)']
