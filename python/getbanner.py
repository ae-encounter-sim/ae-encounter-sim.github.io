...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/d0a728c3e8e008d869a7a0d577373df8?language=en'
    banner_name = 'Wanderers Diary Chapter 3'
    rate_up = ['Claude(ES)','Cynthia(AS)']
