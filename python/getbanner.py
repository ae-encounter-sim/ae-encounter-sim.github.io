...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/1676f3bcdc58bfa18cabac0a98852db1?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Renri AS'
    rate_up = ['Renri(AS)','Philo','Ilulu(AS)']
