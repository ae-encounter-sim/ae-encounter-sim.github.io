...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/bd4016fb56dbca39b5e8422b1f4d2862?q=129301920766&language=en'
    banner_name = 'Manifestation Weapon Discovery Isuka Myrus'
    rate_up = ['Isuka','Myrus']
