...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/109a51559dd7f02f3943cd6cfab58182?language=en'
    banner_name = 'Manifestation Weapon Discovery Akane AS'
    rate_up = ['Akane(AS)']
