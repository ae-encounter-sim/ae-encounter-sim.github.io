...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/b7622cd1b6525a25653e6f07f0d556e6?language=en'
    banner_name = 'Another Style Okaminokami'
    rate_up = ['Yukino','Yukino(AS)']
