...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/e84909d9a4245a9e9d2a48ca27e971f4?language=en'
    banner_name = 'Ally Encounter New Blessing Series'
    rate_up = ['Dunarith','Mariel']
