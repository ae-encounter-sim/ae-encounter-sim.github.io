...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/badc7911e57261e0d4adb6ff70622e37?language=en'
    banner_name = 'Another Style Erato'
    rate_up = ['Pizzica','Pizzica(AS)']
