...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/6a2b65a0d3862d4367b68dab3a600e81?language=en'
    banner_name = 'Ally Encounter Melissa'
    rate_up = ['Melissa','Premaya']
