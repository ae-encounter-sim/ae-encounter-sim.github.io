...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/fad677df12b40bcea9785a47176060e3?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Milsha'
    rate_up = ['Milsha','Foran(AS)','Hozuki(AS)']
