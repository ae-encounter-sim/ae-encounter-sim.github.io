...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/87d25d4c80ffe9519d0bdfd090aabfa4?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Rosetta AS'
    rate_up = ['Rosetta(AS)','Melody','Toova']
