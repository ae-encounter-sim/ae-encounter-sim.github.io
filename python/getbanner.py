...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/6a9899949e9dc836356d21cc9791166c?language=en'
    banner_name = 'Extra Style Lucifer'
    rate_up = ['Suzette','Suzette(ES)']
