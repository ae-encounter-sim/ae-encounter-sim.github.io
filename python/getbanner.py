...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/156df456c5daa4330920476ed8636e1a?q=129301920766&language=en'
    banner_name = 'Another Style Aqua Goddess'
    rate_up = ['Yuna','Yuna(AS)']
