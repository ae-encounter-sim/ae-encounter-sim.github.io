...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/b1e38e10403fc163c7084e53e2a44ef0?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Akane AS'
    rate_up = ['Akane(AS)','Elga(AS)','Biaka']
