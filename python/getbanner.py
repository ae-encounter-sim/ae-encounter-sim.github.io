...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/fe9d15755165273d8ea6e4eb4c4723ae?language=en'
    banner_name = 'Manifestation Weapon Discovery Yuna Dewey'
    rate_up = ['Yuna','Dewey']
