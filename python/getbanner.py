...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/e78ea7ded9f35859950c3022e968ec52?language=en'
    banner_name = 'Fateful Encounter Remittetur'
    rate_up = ['Rosetta','Rosetta(AS)']
