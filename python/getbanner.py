...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/642afc73fce77e446be51b9c296c3cbd?language=en'
    banner_name = 'Ally Encounter Daisy'
    rate_up = ['Daisy','Dunarith(AS)']
