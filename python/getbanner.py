...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/e590afdba78469e89d170b85db23f861?language=en'
    banner_name = 'Manifestation Weapon Discovery Mariel Suzette AS'
    rate_up = ['Mariel','Suzette(AS)']
