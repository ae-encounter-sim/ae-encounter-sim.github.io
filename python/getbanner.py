...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/d3620395e91bec0a5dba430fb145c0f1?language=en'
    banner_name = 'Ally Encounter Alma'
    rate_up = ['Alma','Mistrare']
