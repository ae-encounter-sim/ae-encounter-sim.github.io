...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/84b9bc58f5de49edc3d2b3eef63329f6?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Kikyo'
    rate_up = ['Kikyo','Shigure','Myunfa']
