...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/1f7561acf271ed9781fd73087dae7fa7?language=en'
    banner_name = 'Another Style Rose Unseen'
    rate_up = ['Biaka(AS)','Cetie(AS)']
