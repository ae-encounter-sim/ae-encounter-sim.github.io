...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/f6d3debee67deeb38e56aca27c5f5ee4?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter'
    rate_up = ['Cynthia','Radias','Lovely']
