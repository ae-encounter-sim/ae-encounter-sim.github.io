...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/39821b0ef551709802139f99442f6c5b?language=en'
    banner_name = 'Ally Encounter Yipha'
    rate_up = ['Yipha','Bertrand']
