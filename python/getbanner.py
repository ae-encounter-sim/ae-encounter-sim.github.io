...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/c0db6dec995392a358206caf06f1d6a0?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter Chiyo AS'
    rate_up = ['Hardy(AS)','Chiyo(AS)','Ilulu(AS)']
