...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/0723a866be93f80a33f9d8ce63d0123e?language=en'
    banner_name = 'Fateful Encounter Seven Days Encounter April 2023'
    rate_up = ['Ewella','Soira(AS)','Milsha']
