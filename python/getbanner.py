...
def main():
    url = 'https://api-us.another-eden.games/asset/lottery_notice/view/b0596d07a74937dc7db439c8014a2183?language=en'
    banner_name = 'Another Style Miracle Worker'
    rate_up = ['Lokido(AS)','Lele','Lele(AS)']
